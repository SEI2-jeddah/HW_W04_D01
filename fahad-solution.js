...
var longString = 'hello stranger , what do we have today? ';
console.log(swapCase(longString))
...
var shiftLetters = function(string) {
    ...
    var newWord = word.map(letter => letter.charCodeAt()-1)
    
    var str = String.fromCharCode(...newWord);
    console.log(str);
